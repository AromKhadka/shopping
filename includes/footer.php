...
<h3>SHOP TODAY</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> This is a shoping website which helps less intraction with other and order from home.</p>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <p>(+977) 9821213770<br>(+977) 578498</p>
                </div>
            </li>
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">shoptoday@gmail.com</a></span>
                </div>
            </li>
